...
toast.add_info('Lag Atack v1.7 ready!')
...
sub:add_button('Lag Atack', {"Stay Clear from this!"}, function (playerIdx)
    ...
    for i = 1, 31 do                           
        native.object.create_object(VEHICLE_HASH_2, x, y, z, true, true, true, true, false)
    end        
end)
...
sub:add_button('Big Lag', {"Will Lag you hard if near by!"}, function (playerIdx)
    ...
    local A = native.object.create_object(VEHICLE_HASH_2, x, y, focus_0, true, true, true, true, false)
    ...
    for i = 1, 10 do 
      native.object.create_object(VEHICLE_HASH_2, x, y, focus_4, true, true, true, true, false)
    end
    ...
    for i = 1, 21 do  
        native.object.create_object(VEHICLE_HASH_2, ff, yy, focus_4, true, true, true, true, false)
    end  
